export default function Politician() {
    return (
        <div className="relative bg-gray-400 h-64 my-10 mx-64 flex flex-row rounded-xl">
            <div className="flex flex-row basis-1/3 relative content-center justify-center">
                <img src="/Joe_Biden_presidential_portrait.jpg" alt="Joe Biden" style={{ width: "auto", height: "auto", maxWidth: "100%", maxHeight: "100%" }} className="rounded-3xl my-2" />
            </div>
